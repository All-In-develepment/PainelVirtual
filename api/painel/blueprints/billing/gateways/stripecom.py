...
class Plan(object):
    ...
    def create(cls, id=None, name=None, amount=None, currency=None,
               ...
               metadata=None, statement_descriptor=None, product=None):
        """
        Create a new plan.
...
class Product(object):
    ...
    @classmethod
    def create(cls, id=None, name=None, type=None, metadata=None):
        """
        ...
        :type type: str
        :param metadata: Additional data to save with the product
        :type metadata: dct
        :return: Stripe product
        """
        try:
            return stripe.Product.create(id=id,
                                        name=name,
                                        type=type,
                                        metadata=metadata
                                        )
...
class PaymentMethod(object):
    @classmethod
    def get_payment_methods(cls, customer):
        """
